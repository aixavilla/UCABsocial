...
--
-- Servidor: localhost
-- Tiempo de generación: 27-10-2013 a las 23:14:09
...
CREATE TABLE `albums` (
  ...
  `urlalbum` varchar(100) DEFAULT NULL,
  `imagendescriptiva` varchar(100) DEFAULT NULL,
...
INSERT INTO `albums` (`id`, `nombre`, `created`, `modified`, `urlalbum`, `imagendescriptiva`, `privacidad`, `fkUsers`) VALUES
(1, 'Jheniree', '2013-10-27', NULL, NULL, NULL, 0, 35),
(2, 'Un domingo', '2013-10-27', NULL, NULL, NULL, 0, 35);
...
CREATE TABLE `coments` (
  ...
  `modified` date DEFAULT NULL,
  `fkUsers` int(11) NOT NULL,
  `fkAlbums` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fkUsers` (`fkUsers`),
  KEY `fkAlbums` (`fkAlbums`)
...
CREATE TABLE `friends` (
  ...
  `modified` date DEFAULT NULL,
  `fkUsers` int(11) NOT NULL,
  `fkUsers2` int(11) NOT NULL,
  `pendiente` varchar(3) NOT NULL DEFAULT 'no',
  PRIMARY KEY (`id`),
  KEY `fkUsers` (`fkUsers`),
  KEY `fkUsers_2` (`fkUsers`),
  KEY `fkUsers2` (`fkUsers2`)
...
CREATE TABLE `historic` (
  ...
  `modified` date DEFAULT NULL,
  `fkAlbums` int(11) NOT NULL,
  `fkRecords` int(11) NOT NULL,
  KEY `fkAlbums` (`fkAlbums`),
  KEY `fkRecords` (`fkRecords`)
...
CREATE TABLE `notifications` (
  ...
  `created` date DEFAULT NULL,
  `modified` date DEFAULT NULL,
  `fkComents` int(11) NOT NULL,
  `fkAlbums` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fkComents` (`fkComents`),
  KEY `fkAlbums` (`fkAlbums`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE `requests` (
  ...
  `modified` date DEFAULT NULL,
  `fkComents` int(11) NOT NULL,
  `fkComents2` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fkComents` (`fkComents`),
  KEY `fkComents2` (`fkComents2`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE `users` (
  ...
  `privacidad` varchar(30) DEFAULT 'Público',
  `created` date DEFAULT NULL,
  `modified` date DEFAULT NULL,
  `facebookid` text,
  `googleid` text,
...
INSERT INTO `users` (`id`, `nombre`, `nombre2`, `apellido`, `apellido2`, `username`, `email`, `imagen`, `telefono`, `birthday`, `genero`, `descripcion`, `ubicacion`, `privacidad`, `created`, `modified`, `facebookid`, `googleid`, `urlFacebook`, `urlTwitter`, `urlLinkedin`) VALUES
(35, 'Jheniree', '', 'Gomes', 'Colmenares', 'jhenigc', 'jhenigc@gmail.com', NULL, '04140203062', '1989-12-21', 'Femenino', 'Estudiante de Ingeniería Informática en la UCAB. Feliz =)', 'Caracas, Distrito Federal - Venezuela', 'Público', '2013-10-26', '2013-10-26', '834755194', NULL, 'https://www.facebook.com/jheniree.gomes', 'https://twitter.com/JheniGC', '');
...
--
ALTER TABLE `albums`
  ADD CONSTRAINT `albums_ibfk_2` FOREIGN KEY (`fkUsers`) REFERENCES `users` (`id`);

--
-- Filtros para la tabla `coments`
--
ALTER TABLE `coments`
  ADD CONSTRAINT `coments_ibfk_1` FOREIGN KEY (`fkUsers`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `coments_ibfk_2` FOREIGN KEY (`fkAlbums`) REFERENCES `albums` (`id`);

--
-- Filtros para la tabla `friends`
--
ALTER TABLE `friends`
  ADD CONSTRAINT `friends_ibfk_1` FOREIGN KEY (`fkUsers`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `friends_ibfk_3` FOREIGN KEY (`fkUsers2`) REFERENCES `users` (`id`);

--
-- Filtros para la tabla `historic`
--
ALTER TABLE `historic`
  ADD CONSTRAINT `historic_ibfk_1` FOREIGN KEY (`fkAlbums`) REFERENCES `albums` (`id`),
  ADD CONSTRAINT `historic_ibfk_2` FOREIGN KEY (`fkRecords`) REFERENCES `records` (`id`);

--
-- Filtros para la tabla `notifications`
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `notifications_ibfk_1` FOREIGN KEY (`fkComents`) REFERENCES `coments` (`id`),
  ADD CONSTRAINT `notifications_ibfk_2` FOREIGN KEY (`fkAlbums`) REFERENCES `albums` (`id`);

--
-- Filtros para la tabla `requests`
--
ALTER TABLE `requests`
  ADD CONSTRAINT `requests_ibfk_1` FOREIGN KEY (`fkComents`) REFERENCES `coments` (`id`),
  ADD CONSTRAINT `requests_ibfk_2` FOREIGN KEY (`fkComents2`) REFERENCES `coments` (`id`);
